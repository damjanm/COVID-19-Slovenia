...
if(exists('limit_date')){
  dd <- dd[as.Date(substr(dd$datum, 1,7), format = "%d. %m.")<=limit_date,] # limit data to a given date
  dd_hosp <- dd_hosp[as.Date(substr(dd_hosp$datum, 1,7), format = "%d. %m.")<=limit_date,] # limit data to a given date
} 
