...
make_three_pannel_plot <- function(){
  ...
  load(paste0("combinedTDI/results/", filename2))
...
make_plots <- function(data_country, data_country2, 
  ...
  cowplot::save_plot(filename = paste0("combinedTDI/web/figures/desktop/", country, '_', filename2, "_infections", ".svg"), 
            p1, base_height = 4, base_asp = 1.618)
  cowplot::save_plot(filename = paste0("combinedTDI/web/figures/desktop/", country, '_', filename2, "_deaths", ".svg"), 
            p2, base_height = 4, base_asp = 1.618)
  cowplot::save_plot(filename = paste0("combinedTDI/web/figures/desktop/", country, '_', filename2, "_rt", ".svg"), 
            p3, base_height = 4, base_asp = 1.618 * 2)
  cowplot::save_plot(filename = paste0("combinedTDI/web/figures/desktop/", country, '_', filename2, "_cases", ".svg"), 
            p4, base_height = 4, base_asp = 1.618)
  cowplot::save_plot(filename = paste0("combinedTDI/web/figures/desktop/", country, '_', filename2, "_hosp", ".svg"), 
            p5, base_height = 4, base_asp = 1.618)
  cowplot::save_plot(filename = paste0("combinedTDI/web/figures/desktop/", country, '_', filename2, "_icu", ".svg"), 
  ...
  cowplot::save_plot(filename = paste0("combinedTDI/web/figures/mobile/", country, '_', filename2, "_infections", ".svg"), 
            p1, base_height = 4, base_asp = 1.1)
  cowplot::save_plot(filename = paste0("combinedTDI/web/figures/mobile/", country, '_', filename2, "_deaths", ".svg"), 
            p2, base_height = 4, base_asp = 1.1)
  cowplot::save_plot(filename = paste0("combinedTDI/web/figures/mobile/", country, '_', filename2, "_rt", ".svg"), 
            p3_mobile, base_height = 4, base_asp = 1.5)
  cowplot::save_plot(filename = paste0("combinedTDI/web/figures/mobile/", country, '_', filename2, "_cases", ".svg"), 
            p4, base_height = 4, base_asp = 1.1)
  cowplot::save_plot(filename = paste0("combinedTDI/web/figures/mobile/", country, '_', filename2, "_hosp", ".svg"), 
            p5, base_height = 4, base_asp = 1.1)
  cowplot::save_plot(filename = paste0("combinedTDI/web/figures/mobile/", country, '_', filename2, "_icu", ".svg"), 
            p6, base_height = 4, base_asp = 1.1)
  
  # Save this for plot-forecast:
  save(p1, p3_mobile, file = paste0("combinedTDI/results/", filename2, '_', "graphs.RData"))
  ...
  # p3 <- plot_grid(p5, p6, 
  #                 ncol = 2, rel_widths = c(1, 1))
  # p4 <- plot_grid(p5_IN, p5_OUT,
  #                 ncol = 2, rel_widths = c(1, 1))
  # p5 <- plot_grid(p6_IN, p6_OUT,
  #                 ncol = 2, rel_widths = c(1, 1))
  # p <- plot_grid(p, p2, p3, p4, p5, nrow=5)
  # cowplot::save_plot(filename = paste0("figures/", country, "_three_pannel_", filename2, ".pdf"),
                     # p, base_width = 14*2/3, base_height=7.42*5/2)
  ...
  cowplot::save_plot(filename = paste0("combinedTDI/figures/", country, "_three_pannel_", filename2, ".pdf"),
